...
public interface UserRepository extends JpaRepository<UserEntity, Long> , UserRepositoryCustom {
    ...
    List<UserEntity> findDistinctByRoles_CodeAndBuildings_Id(String roleCode, Long buildingId);
    List<UserEntity> findDistinctByRoles_CodeAndCustomers_Id(String roleCode, Long customerId);
}
