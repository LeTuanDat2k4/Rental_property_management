            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form>
                        ...
                        <div><input type="text" class="form-control mt-3" placeholder="Số điện thoại" id="phoneNumber"></div>
                        <div><input type="text" class="form-control mt-3" placeholder="Nội dung" id="content"></div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        document.querySelector("form").addEventListener("submit", function (event) {
            ...
            if (fullName === "") {
                showError(document.getElementById("fullName"),"Họ và tên không được để trống.");
                isValid = false;
            }
            ...
            if (!phonePattern.test(phoneNumber)) {
                showError(document.getElementById("phoneNumber"),"Số điện thoại phải là số và có từ 9-12 chữ số.");
                isValid = false;
            }
            if (content === "") {
                showError(document.getElementById("content"),"Nội dung không được để trống.");
                isValid = false;
            }
    ...
    function addCustomer(data) {
        $.ajax({
            ...
            success: function (response) {
                ...
                window.location.href = "/lien-he"; // Chuyển hướng sau khi gửi thành công
            },
            error: function (xhr) {
